...
| apl          | APL                 |                     | .apl                            |
| bash         | Bash                |                     | .sh                             |
| basic        | Classic BASIC       |                     | .bas                            |
| bcpl         | BCPL                |                     | .b                              |
| bqn          | BQN                 |                     | .bqn                            |
| c            | C                   |                     | .c                              |
| cgmp         | C with GMP          |                     | (.c)                            |
| cmemcheck    | C with Memory Check |                     | (.c)                            |
| cobol        | COBOL               |                     | .cob, .cbl, .cpy                |
| cpp          | C++                 |                     | .cc, .cpp, .cxx, .c++, .C       |
| cppgmp       | C++ with GMP        |                     | (.cc, .cpp, .cxx, .c++, .C)     |
| cppmemcheck  | C++ with Memory Check |                   | (.cc, .cpp, .cxx, .c++, .C)     |
| crystal      | Crystal             |                     | .cr                             |
| csharp       | C\#                 |                     | .cs                             |
| d            | D                   |                     | .d                              |
| dart         | Dart                |                     | .dart                           |
...
| fortran      | Fortran             |                     | .f90, .f, .for                  |
| fortran77    | Fortran 77          |                     | (.f, .for)                      |
| fsharp       | F\#                 |                     | .fs                             |
| gerbil       | Gerbil              |                     | .ss                             |
| go           | Go                  |                     | .go                             |
| haskell      | Haskell             |                     | .hs, (.c)                       |
| icon         | Icon                |                     | .icn                            |
| java         | Java                | Main                | .java                           |
