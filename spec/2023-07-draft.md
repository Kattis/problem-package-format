...
If the output visualizer does not have sufficient data to generate an adequate visualization using only the command line arguments, it is recommended that the output validator writes the necessary data to the feedback directory.
