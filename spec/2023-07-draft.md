...
| `solution/`                                       | No        | [Solution Description](#solution-description) | Written explanations of how to solve the problems
...
| `input_validators/`                               | Yes       | [Input Validators](#input-validators)         | Programs that verifies correctness of the input files
