...
The existence of the `.in` files declares the existence of the test case.
If the test case exists, then some of the other files are required to exist while others are optional.
