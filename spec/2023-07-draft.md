...
`statement/`           | Yes       | [Statements](#statements)                   | Problem statement files and explanations of how to solve the problem
...
## Statements
The problem statement and solution descriptions are both stored as files inside the directory `statement/`.
Auxiliary files needed by either the problem statement or solution description must also be in `statement/`.
Auxiliary files should be referenced as if the working directory is `statement/`.
Image file formats supported are `.png`, `.jpg`, `.jpeg`, and `.pdf`.

### Problem Statements

The `statement/` directory must contain one file per language, for at least one language, named `problem.<language>.<filetype>`,
...
Problem statements or solution provided in LaTeX must consist only of the problem statement body
...
The `statement/` directory must contain one file per language, for at least one language, named `solution.<language>.<filetype>`,
that contains the description of how the problem is intended to be solved.
