...
* All floating-point numbers must be given in decimal and may use scientific notation.
  ...
  ```
Judging systems may impose reasonable limits on the number of digits, and may round floating-point numbers during parsing to the nearest value representable in a reasonable internal format with at least 52 bits of mantissa precision.
