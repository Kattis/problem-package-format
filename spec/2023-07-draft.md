...
* All floating-point numbers must be given in decimal and may use scientific notation.
...
```
Judging systems may round floating-point numbers during parsing and may impose reasonable limits on the number of digits, but should make a best effort to parse floating-point numbers to the nearest arithmetic value representable in double precision.
