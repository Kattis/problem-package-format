...
If a test data group has no `testdata.yaml` file, some of the keys and their associated values will be inherited
from the `testdata.yaml` in the closest ancestor group from the test case to the root `data` directory that has one.
...
| ---------------------- | ----------------------------------- | ----------------------- | -------------- | --------
| grading                | Map                                 | [See Grading](#grading) | Not inherited  | Description of how the results of the group test cases and subgroups should be aggregated.
