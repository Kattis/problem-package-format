...
otherwise, by looking at the file endings as specified in the [languages table](../appendix/languages.md).
...
otherwise, the default entry point in the [languages table](../appendix/languages.md) will be used.
