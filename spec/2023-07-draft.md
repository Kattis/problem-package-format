...
If a floating-point tolerance has been set, the default output validator will attempt to parse each answer file token as floating-point (see [general requirements](#general-requirements) for details). 
