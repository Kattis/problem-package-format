...
| source                                   | String or sequence of strings                               |                                                          | Who should get source credit. This would typically be the name (and year) of the event where the problem was first used or created for. A sequence is used in the special case that the first use was actually multiple (typically simultaneous) events.
| source_url                               | String or sequence of strings                               |                                                          | Link to page for source event. Must not be given if source is not. Type and length of sequence must be the same as for `source`.
