...
- For input validators: the files in the program directory of the input validator in question, and the contents of the `.files` directory of the test case being validated (if this directory exists). It is an error for file names from `.files` and the input validator to collide.
