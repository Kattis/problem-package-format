...
All of these limits must be positive.
Additionally, `output` may not be smaller than the largest default answer file in the problem, unless a custom output validator is used.
...
Both of these multipliers must be at least 1.
