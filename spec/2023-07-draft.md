...
| credits                                  | Map with keys as defined below                              |                                                          | Who should get credits. See below for details.
...
| Key          | Type                                   | Default | Comments
| ------------ | -------------------------------------- | ------- | --------
| authors      | Sequence of persons                    |         | The people who conceptualized the problem.
| contributors | Sequence of persons                    |         | The people who developed the problem package, such as statement, validators and test data.
| testers      | Sequence of persons                    |         | The people who tested the problem package, for example by providing a solution and reviewing the statement.
