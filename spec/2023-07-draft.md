...
Programs must either provide a `build` or `run` script as specified [above](#programs),
or must be written in C++ or Python 3.
...
it must either provide a `build` or `run` script as specified [above](#programs),
or must be written in C++ or Python 3.
