...
| name                                    | String or map of strings                                    |                                                         | Required. The name of the problem in the languages that there are problem statements for.
If there are statements in more than one language, this must be a map with the language codes as keys and the problem names as values.
