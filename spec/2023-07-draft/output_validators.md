...
To signal that the submission should be run once more, the output validator must exit with code 42 and output the new input in the file `nextpass.in` in the feedback directory.
