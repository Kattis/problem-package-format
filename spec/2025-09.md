...
This section specifies which files take precedence for display and download. The file with highest precedence that is present is the one that should be used. These priorities do not affect what is executed during judging.
