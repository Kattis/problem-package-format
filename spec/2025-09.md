...
Another way is to let the `output_validator` folder contain both the output validator and a separate program for validating `nextpass.in`. Then, they can be guaranteed to run in the correct order using a [run script](#other-programs).
