...
- Files in the package have no maximum size. However, to ensure fluid interoperation with external source control and archival tools, it is recommended that no file exceed 100 MiB in size.
