...
This can configured by using `.out`, `.in.statement`, and `.ans.statement` files.
...
This can configured by using `.out`, `.in.statement`, and `.ans.statement` files. See more in [Displayed test cases](#displayed-test-cases).
