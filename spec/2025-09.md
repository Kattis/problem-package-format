...
Other input validators may reject the test case, accept it, or fail to operate properly (such as throwing a run-time error).
...
Input validator programs report whether a test case is accepted or rejected via their exit code.
Exactly how VIVA and Checktestdata report results is outside the scope of this specification. 
