...
For interactive problems, displaying two files typically does not meaningfully capture how users are expected to interact with the output validator.
...
For multi-pass problems, displaying two files typically does not meaningfully capture how users are expected to interact with the output validator.
Therefore, it is advised to instead provide samples for the problem statement in the form of a `.interaction` file.
