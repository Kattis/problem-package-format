...
| accept\_score                               | String                                                | 1            | If an output validator outputs a score for an accepted input file, it is multiplied by the `accept_score` of the group. Otherwise, the score for the input file is the `accept_score` of the gruop. May only be specified for scoring problems.                                                                                                                                                                                                                               |
